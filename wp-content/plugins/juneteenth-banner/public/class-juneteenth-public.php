				...
				<div class="juneteenth-modal__overlay" tabindex="-1" data-micromodal-close>
					<div class="juneteenth-modal__container" role="dialog" aria-modal="true" aria-labelledby="juneteenth-title">
						...
						<main class="juneteenth-modal__content" id="juneteenth-content">
							...
							<p><a href="https://nmaahc.si.edu/blog-post/celebrating-juneteenth/" target="_blank" rel="noopener" class="juneteenth__learn-more"><?php echo __('Learn More About This Day', 'juneteenth'); ?></a></p>
							<p class="juneteenth_ednc">Today and every day, EdNC is reflecting on our role and the media’s role in perpetuating structural racism.</p>
						</main>
					</div>
				</div>
			</div>
