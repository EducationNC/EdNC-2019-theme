 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Juneteenth Banner (EdNC)
 * Plugin URI:        https://github.com/unitymakesus/juneteenth
 * Description:       Spread Juneteenth awareness with this banner that automatically appears on your website on Juneteenth (WCAG 2.1 AA compliant modal). Links to https://nmaahc.si.edu/blog-post/celebrating-juneteenth for more information on the holiday.
 * Version:           1.0.0
...
function run_juneteenth() {
	 ...
	 */
	$juneteenth = '618'; //TODO: change to 619
