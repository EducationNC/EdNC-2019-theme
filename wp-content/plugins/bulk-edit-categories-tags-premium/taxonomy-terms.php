...
/*
  ...
  Domain Path: /lang
  @fs_premium_only /modules/user-path/send-user-path.php, /modules/acf/, /modules/advanced-filters/, /modules/columns-renaming/, /modules/formulas/, /modules/custom-columns/, /modules/universal-sheet/, /modules/yoast-seo/, 
 */
	...
	class WP_Sheet_Editor_Taxonomy_Terms {
		...
		function notify_wrong_core_version() {
			...
			<div class="notice notice-error">
				<p><?php _e('Please update the WP Sheet Editor plugin and all its extensions to the latest version, the CORE plugin should be version 2.8.3 or higher. The plugin "' . $plugin_data['Name'] . '" requires that version.', vgse_taxonomy_terms()->textname); ?></p>
			</div>
			<?php
		}
