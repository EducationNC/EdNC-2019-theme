...
class Thumbnails extends Isotope_Gallery {
	...
	protected function getDeprecatedSettings(){
		return array_merge(parent::getDeprecatedSettings(),
			array()
		);
	}
	...
	protected function renderItem($image, &$settings){
		...
		$render .= '<div class="gt3pg-thumbnails-item '.$ratio_class.'" data-index="'.esc_attr($this->render_item_index).'"><div class="isotope_item-wrapper"><div class="img-wrapper">';
	...
	protected function render($settings){
		...
		<div <?php $this->print_render_attribute_string('wrapper'); ?>>
			<div class="gallery-thumbnails-wrapper <?php echo 'size-'.$settings['thumbnails_Size']; ?>">
				<?php
				echo $items; // XSS Ok
				?>
			</div>
