...
== Changelog ==
= V 1.5.0 - 2020-05-20 =
* NEW - TERMS - Improve the edition of wc attributes
* FIX - TERMS - Sometimes the import edits the taxonomy incorrectly


= V 1.5.0 - 2020-04-20 =
* NEW - TERMS - Add more options to the merge tool
...
= V 1.2.3 - 2019-11-18 =
* CHANGE - TERMS - Display user friendly names instead of encoded special characters
* FIX - TERMS - IMPORT - When we update existing by ID, it doesn't find the existing term to update
* FIX - TERMS - When searching by keyword, it returns empty results but the term exists
...
= V 1.2.0 - 2019-10-01 =
* NEW - TERMS - FILTERS - Added option to search by parent keyword
* FIX - TERMS - YOAST - Fatal error when importing if the term doesn't have yoast fields
* FIX - TERMS - FORMULAS - We can't delete terms in bulk

= V 1.1.0.1 - 2019-09-06 =
