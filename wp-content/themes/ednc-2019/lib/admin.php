...
add_filter( 'manage_post_posts_columns', __NAMESPACE__ . '\\posts_custom_column_heading', 12, 1 );
add_action( 'manage_post_posts_custom_column', __NAMESPACE__ . '\\posts_custom_column_content', 12, 2 );

// edtalk
function edtalk_custom_column_heading($columns) {
	$new_columns['cb'] = 'cb';
	$new_columns['title'] = 'Title';
	$new_columns['author'] = 'Author';
	$new_columns['podcast'] = 'Podcast';
	$new_columns['date'] = 'Date';
...
function edtalk_custom_column_content($column_name, $id) {
	if ( 'podcast' == $column_name ) {
		echo get_the_term_list($id, 'podcast', '', ', ', '');
	}
}

add_filter( 'manage_edtalk_posts_columns', __NAMESPACE__ . '\\edtalk_custom_column_heading', 12, 1 );
add_filter( 'manage_edtalk_posts_custom_column', __NAMESPACE__ . '\\edtalk_custom_column_content', 12, 2 );
...
add_filter( 'manage_map_posts_columns', __NAMESPACE__ . '\\maps_custom_column_heading', 12, 1 );
add_filter( 'manage_map_posts_custom_column', __NAMESPACE__ . '\\maps_custom_column_content', 12, 2 );
...
add_filter( 'manage_bill_posts_columns', __NAMESPACE__ . '\\bills_custom_column_heading', 12, 1 );
add_filter( 'manage_bill_posts_custom_column', __NAMESPACE__ . '\\bills_custom_column_content', 12, 2 );
...
add_filter( 'manage_resource_posts_columns', __NAMESPACE__ . '\\resources_custom_column_heading', 12, 1 );
add_filter( 'manage_resource_posts_custom_column', __NAMESPACE__ . '\\resources_custom_column_content', 12, 2 );
...
add_filter( 'manage_bio_posts_columns', __NAMESPACE__ . '\\bios_custom_column_heading', 12, 1 );
add_filter( 'manage_bio_posts_custom_column', __NAMESPACE__ . '\\bios_custom_column_content', 12, 2 );
...
add_filter( 'manage_gallery_posts_columns', __NAMESPACE__ . '\\galleries_custom_column_heading', 12, 1 );
add_filter( 'manage_gallery_posts_custom_column', __NAMESPACE__ . '\\galleries_custom_column_content', 12, 2 );
