...
<div class="social-share-buttons print-no">
  <?php if ($count_num != 0) { ?>
  <?php } ?>
  <a rel="nofollow" target="_blank" class="icon-facebook social-share-link" href="<?php echo $facebookURL; ?>">
    Share on facebook
  </a>
  ...
  <a rel="nofollow" target="_blank" class="other-share icon-fax hidden-xs hidden-sm" <?php echo $printLink; ?> target="_blank">
    Print this page
  </a>
</div>
